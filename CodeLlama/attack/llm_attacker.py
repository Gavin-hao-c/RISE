...
import re
import json
from utils import select_parents, crossover, map_chromesome, mutate, is_valid_variable_name
from utils import select_parents, crossover, map_chromesome, mutate, is_valid_variable_name
...
class Attention_Attacker():
    ...
    def att_attack(self, true_label, id2token, code_lines, adv_codes, query):
        ...
        for adv_code in adv_codes:
            sorted_line_numbers = get_importance_score_taa(
            ...
            for position in sorted_line_numbers:
                ...
                base_prob, base_pred, _ = get_llm_result(current_code, self.model_tgt, self.tokenizer_tgt, true_label)
                query_times += 1
                if query_times >= 500:
